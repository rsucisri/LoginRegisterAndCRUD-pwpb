<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $pass = empty($_POST['password']) ? $row['password'] : md5($_POST['password']);

        $result = mysqli_query($conn, "UPDATE users SET name='$name', user_name='$uname', password='$pass' WHERE id=$id");
        if ($result) {
        ...
        <form class="col col-sm-5 col-lg-6 col-md-7" action="" method="POST">
            <div class="mb-3">
             ...
             <div class="mb-3">
                ...
                <input type="username" name="user_name" placeholder="Username"  class="form-control">
            </div>
            <div class="mb-3">
